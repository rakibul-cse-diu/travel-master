...
const NavBar = () => {
    ...
    return (
        <div className='flex justify-between items-center rounded-lg'>
            ...
            <div className='flex bg-gray-200/30 p-1 w-1/3'>
            ...
            <nav className={`w-1/2 text-lg text-[#F9A51A] lg:text-white font-normal bg-gray-100 lg:bg-transparent flex flex-col lg:flex-row absolute right-0 lg:static duration-500 ${open ? 'top-0' : 'top-[-500px]'}`}>
